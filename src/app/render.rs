...
impl Render for Waku {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let content = div()
            ...
            .on_action(cx.listener(Self::increase_ui_font_size_action))
            .on_action(cx.listener(Self::decrease_ui_font_size_action))
            .on_action(cx.listener(Self::reset_ui_font_size_action))
            .on_modifiers_changed(cx.listener(Self::task_switcher_modifiers_changed))
